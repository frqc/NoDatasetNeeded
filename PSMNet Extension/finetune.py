...
if args.datatype == '2015':
    ...
    args.datapath = "/home/tim/data/training/"
elif args.datatype == 'carla':
    from dataloader import carla_loader as ls
    args.datapath = "/home/tim/script/carla_script/_six_out/"
...
def train(imgL, imgR, disp_L):
    ...
    if args.model == 'stackhourglass':
        ...
        loss1 = F.smooth_l1_loss(
            output1, disp_true, reduction='mean')
        loss2 = F.smooth_l1_loss(
            output2, disp_true, reduction='mean')
        loss3 = F.smooth_l1_loss(
            output3, disp_true, reduction='mean')
...
def main():
    ...
    for epoch in range(1, args.epochs+1):
        ...
        print('epoch %d total 3-px error rate in val = %.3f' %
